      ...
      <div className=' flex flex-col lg:flex-[50%] w-[100%]  text-black   '>
          ...
          <div className='bg-[#007991] lg:w-[90%] lg:h-[180px] h-0  rounded-xl  '>
            ...
            <div className='flex flex-col text-black font-semibold lg:text-xl text-l gap-4 lg:p-7 p-0'>
                ...
                <h3>You've learned 85% of your goal. <br /> Keep learning and improve your overall  <br /> results.</h3>
            </div>
            <div>
                <img className='lg:w-44 h-36 rounded-lg  lg:ml-[350px] ml-5 lg:mt-4 mt-11 flex justify-end items-end ' src="https://websitedemos.net/online-courses-02/wp-content/uploads/sites/542/2021/03/instructor-02-free-img.jpg" alt="" />
            </div>
            </div>
             ...
             <div className='bg-[#007991] w-[80%] rounded-xl p-3 h-24 lg:mb-0 mb-4'>
              <div>
               ...
               <div>
               <Link to='/assignment'><button className='bg-[#007991] rounded-lg py-1'>Create a simple login page</button></Link> 
            ...
            <div className='flex flex-col flex-[50%] bg-[#007991] h-[60vh] rounded-xl pt-5'>
              ...
              <div className='mt-14'>
                <p className=' ml-3 flex relative'><BsDot className='text-blue-600 text-3xl' /> 9:00AM</p>
                ...
                <p><BsDot /></p>
                <p><BsDot /></p>
                           <h1 className='relative bottom-16 right-0 px-8'>Frontend Programming</h1>
                 
                </div>
              </div>
              <div>
                <p className='ml-3 flex'><BsDot className='text-blue-600 text-3xl'/> 11:00AM</p>
                <div className='ml-4 relative'>
                <p><BsDot /></p>
                <p><BsDot /></p>
                <p><BsDot /></p>

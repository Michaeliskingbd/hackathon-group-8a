...
import { Calendar, BookOpen, TrendingUp, Award, Clock, ChevronRight, Target } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="bg-gradient-to-r from-cyan-600 to-blue-600 rounded-2xl p-8 text-white shadow-xl">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-cyan-100 text-lg">You've learned 85% of your goal this month</p>
              <p className="text-cyan-50 mt-1">Keep learning and improve your overall results</p>
            ...
            <img 
              className="w-36 h-36 rounded-full object-cover border-4 border-white/30 shadow-lg hidden md:block" 
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-xl p-6 shadow-md">
            <h2 className="text-xl font-bold text-gray-800 mb-4">Time Distribution</h2>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                <Pie
                  data={timeData}
            ...
            <ResponsiveContainer width="100%" height={300}>
              <BarChart data={courseData}>
                ...
                <Tooltip 
                  contentStyle={{ backgroundColor: '#fff', border: '1px solid #e5e7eb', borderRadius: '8px' }}
                />
                <Bar dataKey="completion" fill="#0891b2" radius={[8, 8, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-md">
            ...
            <div className="space-y-4">
              {schedule.map((item, index) => (
                <div key={index} className="flex gap-4 p-4 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg hover:shadow-md transition-shadow">
          ...
          <div className="lg:col-span-3 bg-[#007991] rounded-xl p-6 shadow-md text-white">
            <div className="flex items-center justify-between">
              <div>
                <h3 className="text-lg font-semibold mb-2">Current Assignment</h3>
                <p className="text-2xl font-bold">Create a Simple Login Page</p>
                <p className="mt-2 text-purple-100">Due in 3 days • React & CSS</p>
              </div>
            <Link to='/assignment'>

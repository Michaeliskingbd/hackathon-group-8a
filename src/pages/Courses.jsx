...
const Courses = () => {
  const courses = [
    { id: 1, title: 'Full Stack Web Development', progress: 75, modules: 12, completed: 9 },
    { id: 2, title: 'React & Modern JavaScript', progress: 90, modules: 8, completed: 7 },
    { id: 3, title: 'UI/UX Design Fundamentals', progress: 45, modules: 10, completed: 4 }
  ];
        ...
        {courses.map(course => (
          <article key={course.id} className="hover:shadow-lg transition-shadow">
            <div>
              ...
              <div>{course.completed} of {course.modules} modules</div>
            </div>
            <div>
              <div className="mb-4">

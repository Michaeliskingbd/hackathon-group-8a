        ...
        <div className='absolute inset-0 bg-[#007991] opacity-80 rounded-br-[200px] '>
         ...
         <nav className='flex justify-between p-6 items-center'>
                   ...
                   {/* //Desktop button */}
                    ...
                    <button onClick={() => setMenuOpen(!menuOpen)}
                     className='lg:hidden mr-5 flex justify-end items-end  text-white bg-orange-400'>
                        {menuOpen ? <IoClose /> : <GiHamburgerMenu className='p-1 text-3xl' />
                ...
                {menuOpen && (
                  <div className="absolute top-20 left-0 w-full bg-white bg-opacity-95 text-black flex flex-col items-center space-y-4 py-6 lg:hidden z-[1000] transition-all duration-300 ">
                    <ul className="flex flex-col items-center space-y-4 text-lg">
                      ...
                      <li className="hover:text-orange-300 cursor-pointer">All Courses</li>
                      <li className="hover:text-orange-300 cursor-pointer">About Us</li>
                      <li className="hover:text-orange-300 cursor-pointer">Instructors</li>
                      <li className="hover:text-orange-300 cursor-pointer">Prices & FAQ</li>
             ...
             <div className='lg:m-16 m-0 lg:pl-20 pl-7 lg:pt:0 pt-11 flex flex-col gap-5 z-50'>
                <h1 className='font-bold lg:text-8xl text-2xl text-white z-50'>Get in Touch</h1>
                <p className='text-white lg:w-[500px] w-68 z-50 '>At the heart of our e-learning platform is a group of passionate educators and real industry experts who bring real-world experience into every lesson.
        </p>
                </div>

...
const Navbar = () => {
  ...
  return (
    ...
    className='relative bg-[url("https://websitedemos.net/online-courses-02/wp-content/uploads/sites/542/2021/03/bg-07-free-img.jpg")] lg:h-[430px] bg-center bg-cover'>
            <div 
            style={{borderBottomRightRadius: "150px"}}
            className='absolute inset-0 bg-[#007991] opacity-85'></div>

            <div className='relative z-50 flex items-center justify-between lg:px-[78px] px-6 py-4'>
                <img 
                width={150}
                src="https://websitedemos.net/online-courses-02/wp-content/uploads/sites/542/2020/02/logo-regular-free-img.png" alt="alt" />

                <div className='lg:hidden bg-[#ff9635] p-2'>
                 {showMobileNav ?  (<MdClose
                 data-aos="fade-in"
                ...
                <div className='lg:flex items-center gap-10 text-white hidden'>
                    ...
                    <button 
                    className='px-5 py-2 font-[poppins] font-semibold tracking-wider w-[200px] bg-[#ff9635] transition-all duration-150 ease-in rounded-full hover:bg-[#007991]'>
                    START LEARNING</button>
                </div>
            </div>

            <div className='relative z-50 lg:px-[78px] px-6 lg:pt-24 pt-10 pb-20 lg:pb-0 text-white'>
                <h1 className='lg:text-[75px] text-[40px] font-[poppins] font-semibold'>About Us</h1>
                <p className='text-[14px] lg:text-[18px]'>We empower you to code, build, and launch. Learn software development with hands-on <br className='lg:block hidden' />

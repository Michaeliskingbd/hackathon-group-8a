      ...
      <article className="bg-white w-fit mx-10 my-14 pl-[78px] pr-12 py-24">
        <div className="">
          <img
            ...
            className=""
          />
          <h4 className="font-bold text-2xl py-5">HTML5/CSS3 Essentials</h4>
          ...
          <ul className="list-disc list-inside px-6 pb-6">
            <li>An easy and good start for the starters.</li>
            <li>Learn to design and code.</li>
        ...
        <div className="flex lg:flex-row gap-4 flex-col justify-between pt-20 pb-10">
          ...
          <button className=" text-white justify-center flex items-center gap-2 bg-orange-300 text-sm px-5 py-3 font-semibold rounded-3xl">
            <IoIosArrowDown />
            Expand All
          </button>
        </div>

...
const Courses = () => {
    ...
    <section className="font-sans">
      ...
      <section className="relative h-[70vh] flex flex-col justify-center px-10 bg-gradient-to-r bg-[#007991] text-white overflow-hidden rounded-br-[80px]">
        ...
        <div className="max-w-2xl">
          <h1 className="text-5xl md:text-6xl font-extrabold mb-6">All Courses</h1>
 <p className="text-lg md:text-xl text-gray-100 leading-relaxed">
  ...
  {/* Header Section */}
      <p className="text-sm uppercase text-black-500 font-semibold">Course Program</p>
    ...
    <p className="text-gray-600 max-w-3xl">
      Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim.    </p>
  </div>
...
<footer className="bg-white border-t border-gray-200 py-12 px-6 md:px-16">
  <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-10">
    ...
    <div>
      <div className="flex items-center gap-2 mb-3">
        <img src="https://websitedemos.net/online-courses-02/wp-content/uploads/sites/542/2020/04/logo-retina.png" alt="Logo" className="w-50 h-20" />
        <div>
        </div>
</div>
      <p className="text-gray-600 mb-4">
      ...
      <div className="flex gap-4 text-gray-600">
        <a href="#" className="hover:text-teal-600"><i className="fab fa-facebook-f"></i></a>
        <a href="#" className="hover:text-teal-600"><i className="fab fa-twitter"></i></a>
        <a href="#" className="hover:text-teal-600"><i className="fab fa-pinterest-p"></i></a>
        <a href="#" className="hover:text-teal-600"><i className="fab fa-youtube"></i></a>
      </div>
    </div>
 ...
 <li className="hover:text-teal-600 cursor-pointer">LMS Interactive Content</li>
        <li className="hover:text-teal-600 cursor-pointer">Become a PHP Master</li>
        <li className="hover:text-teal-600 cursor-pointer">HTML5/CSS3 Essentials</li>
        <li className="hover:text-teal-600 cursor-pointer">JavaScript Development</li>
        <li className="hover:text-teal-600 cursor-pointer">WordPress Basic Tutorial</li>
        <li className="hover:text-teal-600 cursor-pointer">Introduction to Coding</li>
      </ul>
    </div>
    ...
    <div>
      ...
      <ul className="space-y-2 text-black-600">
        ...
        <li><span className="font-bold">Phone:</span></li>
        <p>929-242-6868</p>
...
<p> contact@info.com</p>
  ...
  {/* Footer bottom */}
  <div className=" flex justify-between items-center border-t border-gray-200 mt-10 pt-6 text-left text-gray-500 text-m"> Copyright 
    © {new Date().getFullYear()} Online Courses.
    <span className="flex justify-end text-gray-500 text-m">Powered by Online Courses</span>
  </div>
  </footer>
    </section>
  );
